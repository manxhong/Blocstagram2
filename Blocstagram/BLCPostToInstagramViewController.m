...
//  Blocstagram
//
//  Created by Man Hong Lee on 10/29/15.
...
- (instancetype) initWithImage:(UIImage *)sourceImage {
    ...
    if (self) {
        ...
        self.filterTitles = [NSMutableArray arrayWithObjects:NSLocalizedString(@"None", @"Label for when no filter is applied to a photo"),nil];
...
-(void) viewDidLoad {
    ...
    [self.filterCollectionView registerClass:[BLCInstagramCollectionViewCell class] forCellWithReuseIdentifier:@"cell"];
...
-(UICollectionViewCell *) collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    BLCInstagramCollectionViewCell *cell = (BLCInstagramCollectionViewCell*)[collectionView dequeueReusableCellWithReuseIdentifier:@"cell" forIndexPath:indexPath];
...
-(void) addFilterToQueue {
    ...
    [self.photoFilterOperationQueue addOperationWithBlock:^{
        ...
        CIFilter *whiteSpecks = [CIFilter filterWithName:@"CIColorMatrix" keysAndValues:kCIInputImageKey, randomImage,
                                 ...
                                 @"inputAVector", [CIVector vectorWithX:0.0 Y:1.0 Z:0.0 W:0.0],
...
-(void) sendButtonPressed:(id)sender {
    ...
    if ([[UIApplication sharedApplication] canOpenURL:instagramURL]) {
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"LOL" message:NSLocalizedString(@"Add a caption and send you image in the Instagram app", @"send image instructions") delegate:self cancelButtonTitle:NSLocalizedString(@"Cancel", @"cancel button") otherButtonTitles:NSLocalizedString(@"Send", @"Send button"), nil];
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"No Instagram App", nil) message:NSLocalizedString(@"The Instagram app isn't INSTALLED on your device. Please install it from the APP Store", nil) delegate:nil cancelButtonTitle:NSLocalizedString(@"OK", "OK") otherButtonTitles:nil];
        [alert show];
    }
}
